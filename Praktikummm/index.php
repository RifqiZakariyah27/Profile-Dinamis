    ...
    <html>
        ...
        <link rel="stylesheet" href="assest/css/profil.css">
        ...
        <body>
            ...
            <section id="box-profile">
                <div class="image-profile">
                    <div class="photo" style="background-image:url(assest/img/20180702_130747.jpg);"></div>
                </div>
                <div class="description">
                    <h1 id="pName"><?php echo $nama; ?></h1>
                    <p id="pRole"><?php echo $role; ?></p>
                    <a href="#input-from" class="button bg-green" onclick="editForm()">Edit</a>
                ...
                <div class="information">
                    ...
                    <div class="data">
                        ...
                        <p id="pExperience" class="text-grey"><?php echo $years_experience; ?></p>
                    </div>
                    <div class="data">
            ...
            <section id="input-form">
                <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                    ...
                    <div class="form">
                        ...
                        <input id="inpYears" type="text" name="years_experience">
                    </div>
                    <div class="form">
                        <label>Email</label>
